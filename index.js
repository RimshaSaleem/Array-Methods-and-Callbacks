...
console.log('task1a',finals2014);

//(b) Away Team name for 2014 world cup final
console.log('task1b',finals2014[0]['Home Team Name']);
...
console.log('task2',getFinals(finals2014));
...
console.log('task3',getYears(getFinals(finals2014)));
...
function getWinnersByYear(array, string, number) {
    const result = string(array, getFinals).map((year, winner) => `In ${year}, ${number(array)[winner]} won the world cup!`);
    return result;
}
